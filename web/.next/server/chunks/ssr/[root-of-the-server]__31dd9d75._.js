...
(()=>{
    const e = new Error("Cannot find module '@strife/common'");
...
class AccountService extends BaseService {
    get baseUrl() {
        return `https://localhost:3000/accounts`;
    }
    createAccount(data) {
        return this.post(CreateAccountSchema, undefined, data);
    }
    deleteAccount() {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31dd9d75._.js.map