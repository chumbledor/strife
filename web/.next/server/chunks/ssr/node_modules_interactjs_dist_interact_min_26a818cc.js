module.exports = [
"[project]/node_modules/interactjs/dist/interact.min.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
/* interact.js 1.10.27 | https://raw.github.com/taye/interact.js/main/LICENSE */ !function(t1, e) {
    ...
    function d(t1) {
        var e = function(t1, e) {
            ...
            return (("TURBOPACK compile-time truthy", 1) ? String : "TURBOPACK unreachable")(t1);
        }(t1, "string");
    ...
    "undefined" != "undefined" && window && m(window);
    var b = function(t1) {
    ...
    function Tt(t1, e, n) {
        ...
        var h = function(t1) {
            for(var e, n, r, i = [], o = 0; o < t1.length; o++){
                ...
                if (a && o !== e) if (s) {
                    var c = C(a), l = C(s);
                    if (c !== a.ownerDocument) if (l !== a.ownerDocument) if (c !== l) {
                        i = i.length ? i : j(s);
                        var u = void 0;
    ...
    var qt = {
        ...
        onInteractionMove: function(t1) {
            ...
            if (e.interacting() && qt.check(e.interactable, e.prepared.name)) if (e.simulation) qt.x = qt.y = 0;
            else {
    ...
    if (un.use(he), un.use(Ce), un.use(Zn), un.use(qe), un.use(Ln), un.use(pe), un.use(Xt), un.use(Gt), un.use(er), un.default = un, "object" === (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : n(module)) && module) try {
        module.exports = un;
    } catch (t1) {}
...
//# sourceMappingURL=node_modules_interactjs_dist_interact_min_26a818cc.js.map