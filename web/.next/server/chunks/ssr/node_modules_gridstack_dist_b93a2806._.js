module.exports = [
"[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gridstack/dist/gridstack-engine.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)");
;
/**
 ...
 */ class GridStackEngine {
     ...
     * return true if we moved. */ _fixCollisions(node, nn = node, collide, opt = {}) {
        ...
        while(collide = collide || this.collide(node, area, opt.skip)){
            ...
            (!this.collide(collide, {
                ...
                moved = this._loading && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(node, newNN) ? true : this.moveNode(node, newNN);
                if ((collide.locked || this._loading) && moved) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(nn, node); // moving after lock become our new desired location
                } else if (!collide.locked && moved && opt.pack) {
                    // we moved after and will pack: do it now and keep the original drop location, but past the old collide to see what else we might push way
                    this._packNodes();
                    nn.y = collide.y + collide.h;
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(node, nn);
                }
     ...
     */ collide(skip, area = skip, skip2) {
        ...
        return this.nodes.find((n)=>n._id !== skipId && n._id !== skip2Id && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isIntercepted(n, area));
    }
    /**
     ...
     */ collideAll(skip, area = skip, skip2) {
        const skipId = skip._id;
        const skip2Id = skip2?._id;
        return this.nodes.filter((n)=>n._id !== skipId && n._id !== skip2Id && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isIntercepted(n, area));
    }
    ...
    */ /**
     ...
     */ swap(a, b) {
        ...
        if (a.w === b.w && a.h === b.h && (a.x === b.x || a.y === b.y) && (touching = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isTouching(a, b))) return _doSwap();
        if (touching === false) return; // IFF ran test and fail, bail out
        // check for taking same columns (but different height) and touching
        if (a.w === b.w && a.x === b.x && (touching || (touching = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isTouching(a, b)))) {
            if (b.y < a.y) {
                const t = a;
                a = b;
                b = t;
        ...
        if (a.h === b.h && a.y === b.y && (touching || (touching = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isTouching(a, b)))) {
            if (b.x < a.x) {
                const t = a;
                a = b;
                b = t;
     ...
     */ sortNodes(dir = 1) {
        this.nodes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sort(this.nodes, dir);
        return this;
    }
     ...
     */ prepareNode(node, resizing) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].defaults(node, defaults);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sanitizeMinMax(node);
     ...
     */ nodeBoundFix(node, resizing) {
        const before = node._orig || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, node);
        if (node.maxW) {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(node, before)) {
            node._dirty = true;
        }
        return this;
    }
     ...
     */ getDirtyNodes(verify) {
        ...
        if (verify) {
            return this.nodes.filter((n)=>n._dirty && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(n, n._orig));
        }
     ...
     */ saveInitial() {
        this.nodes.forEach((n)=>{
            n._orig = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, n);
            delete n._dirty;
        });
     ...
     */ restoreInitial() {
        this.nodes.forEach((n)=>{
            if (!n._orig || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(n, n._orig)) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(n, n._orig);
            n._dirty = true;
        });
        this._notify();
        return this;
     ...
     */ findEmptyPosition(node, nodeList = this.nodes, column = this.column, after) {
        ...
        for(let i = start; !found; ++i){
            ...
            if (!nodeList.find((n)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].isIntercepted(box, n))) {
     ...
     */ moveNodeCheck(node, o) {
        ...
        clone.nodes.filter((n)=>n._dirty).forEach((c)=>{
            ...
            if (!n) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(n, c);
            n._dirty = true;
        });
        this._notify();
        return true;
    ...
    /** return true if can fit in grid height constrain only (always true if no maxRow) */ willItFit(node) {
        ...
        if (clone.getRow() <= this.maxRow) {
            node._willFitPos = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, n);
            return true;
        }
        return false;
    }
    ...
    /** return true if the passed in node was actually moved (checks for no-op and locked) */ moveNode(node, o) {
        ...
        const nn = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, node, true); // get min/max out first, then opt positions next
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(nn, o);
        this.nodeBoundFix(nn, resizing);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(o, nn);
        if (!o.forceCollide && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(node, o)) return false;
        const prevPos = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, node);
        ...
        if (collides.length) {
            ...
            if (activeDrag && collide && node.grid?.opts?.subGridDynamic && !node.grid._isTemp) {
                const over = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].areaIntercept(o.rect, collide._rect);
                const a1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].area(o.rect);
                const a2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].area(collide._rect);
        ...
        if (needToMove && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(node, nn)) {
            node._dirty = true;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(node, nn);
        }
        if (o.pack) {
        ...
        return !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(node, prevPos); // pack might have moved things back
    }
    getRow() {
    ...
    */ save(saveElement = true, saveCB, column) {
        ...
        this.nodes.forEach((n)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].removeInternalForSave(w, !saveElement);
     ...
     */ columnChanged(prevColumn, column, layout = 'moveScale') {
        ...
        let newNodes = [];
        let nodes = doCompact ? this.nodes : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sort(this.nodes, -1); // current column reverse sorting so we can insert last to front (limit collision)
        ...
        if (doCompact) {
            ...
            newNodes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sort(newNodes, -1);
...
"[project]/node_modules/gridstack/dist/types.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gridstack/dist/dd-manager.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gridstack/dist/dd-touch.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-manager.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)");
;
;
const isTouch = "undefined" !== 'undefined' && typeof document !== 'undefined' && ('ontouchstart' in document || 'ontouchstart' in window || window.DocumentTouch && document instanceof window.DocumentTouch || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0);
 ...
 */ function simulateMouseEvent(e, simulatedType) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].simulateMouseEvent(e.changedTouches[0], simulatedType);
}
/**
 ...
 */ function simulatePointerMouseEvent(e, simulatedType) {
    ...
    if (e.cancelable) e.preventDefault();
    // Dispatch the simulated event to the target element
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].simulateMouseEvent(e, simulatedType);
}
...
function touchend(e) {
    ...
    const wasDragging = !!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement;
...
function pointerenter(e) {
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement) {
...
"[project]/node_modules/gridstack/dist/dd-resizable-handle.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-touch.js [app-ssr] (ecmascript)");
;
class DDResizableHandle {
    ...
    /** @internal */ _init() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.addEventListener('touchstart', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchstart"]);
            this.el.addEventListener('pointerdown', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerdown"]);
    ...
    /** call this when resize handle needs to be removed and cleaned up */ destroy() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.removeEventListener('touchstart', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchstart"]);
            this.el.removeEventListener('pointerdown', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerdown"]);
        }
    ...
    /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */ _mouseDown(e) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.addEventListener('touchmove', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchmove"]);
            this.el.addEventListener('touchend', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchend"]);
        }
        e.stopPropagation();
        e.preventDefault();
    }
    ...
    /** @internal */ _mouseUp(e) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.removeEventListener('touchmove', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchmove"]);
            this.el.removeEventListener('touchend', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchend"]);
        }
        delete this.moving;
...
"[project]/node_modules/gridstack/dist/dd-base-impl.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gridstack/dist/dd-resizable.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$resizable$2d$handle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-resizable-handle.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$base$2d$impl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-base-impl.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-manager.js [app-ssr] (ecmascript)");
;
;
;
;
class DDResizable extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$base$2d$impl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDBaseImplement"] {
    ...
    /** @internal turns auto hide on/off */ _setupAutoHide(auto) {
        if (auto) {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement === this) {
                delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement;
            }
        }
        return this;
    }
    ...
    _mouseOver(e) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement = this;
    ...
    _mouseOut(e) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement !== this) return;
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].overResizeElement;
        // console.log(`${count++} leave ${(this.el as GridItemHTMLElement).gridstackNode._id}`)
        this.el.classList.add('ui-resizable-autohide');
    }
    /** @internal */ _setupHandlers() {
        this.handlers = this.option.handles.split(',').map((dir)=>dir.trim()).map((dir)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$resizable$2d$handle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDResizableHandle"](this.el, dir, {
                start: (event)=>{
    ...
    /** @internal */ _resizeStart(event) {
        this.sizeToContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(this.el.gridstackNode, true); // strick true only and not number
        this.originalRect = this.el.getBoundingClientRect();
        this.scrollEl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getScrollElement(this.el);
        this.scrollY = this.scrollEl.scrollTop;
        this.scrolled = 0;
        this.startEvent = event;
        this._setupHelper();
        this._applyChange();
        const ev = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].initEvent(event, {
            type: 'resizestart',
            target: this.el
        });
    ...
    /** @internal */ _setupHelper() {
        ...
        const dragTransform = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getValuesFromTransformedElement(parent);
        this.rectScale = {
...
"[project]/node_modules/gridstack/dist/dd-draggable.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// let count = 0; // TEST
class DDDraggable extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$base$2d$impl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDBaseImplement"] {
    constructor(el, option = {}){
        super();
        this.el = el;
        this.option = option;
    ...
    enable() {
        ...
        this.dragEls.forEach((dragEl)=>{
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
                dragEl.addEventListener('touchstart', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchstart"]);
                dragEl.addEventListener('pointerdown', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerdown"]);
    ...
    disable(forDestroy = false) {
        ...
        this.dragEls.forEach((dragEl)=>{
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
                dragEl.removeEventListener('touchstart', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchstart"]);
                dragEl.removeEventListener('pointerdown', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerdown"]);
            }
        });
    ...
    /** @internal call when mouse goes down before a dragstart happens */ _mouseDown(e) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].mouseHandled) return;
        ...
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement;
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement;
        ...
        document.addEventListener('mouseup', this._mouseUp, true);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            e.currentTarget.addEventListener('touchmove', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchmove"]);
            e.currentTarget.addEventListener('touchend', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchend"]);
        }
        e.preventDefault();
        // preventDefault() prevents blur event which occurs just after mousedown event.
        // if an editable content has focus, then blur must be call
        if (document.activeElement) document.activeElement.blur();
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].mouseHandled = true;
        return true;
    }
    /** @internal method to call actual drag event */ _callDrag(e) {
        if (!this.dragging) return;
        const ev = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].initEvent(e, {
            target: this.el,
            type: 'drag'
        });
        if (this.option.drag) {
    ...
    /** @internal called when the main page (after successful mousedown) receives a move event to drag the item around the screen */ _mouseMove(e) {
        ...
        if (this.dragging) {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag) {
                const pause = Number.isInteger(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag : 100;
                if (this.dragTimeout) window.clearTimeout(this.dragTimeout);
             ...
             * don't start unless we've moved at least 3 pixels
             */ this.dragging = true;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement = this;
            // if we're dragging an actual grid item, set the current drop as the grid (to detect enter/leave)
            const grid = this.el.gridstackNode?.grid;
            if (grid) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement = grid.el.ddElement.ddDroppable;
            } else {
                delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement;
            }
            this.helper = this._createHelper();
            this._setupHelperContainmentStyle();
            this.dragTransform = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getValuesFromTransformedElement(this.helperContainment);
    ...
    /** @internal call when the mouse gets released to drop the item at current location */ _mouseUp(e) {
        document.removeEventListener('mousemove', this._mouseMove, true);
        document.removeEventListener('mouseup', this._mouseUp, true);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"] && e.currentTarget) {
            e.currentTarget.removeEventListener('touchmove', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchmove"], true);
            e.currentTarget.removeEventListener('touchend', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["touchend"], true);
        }
        if (this.dragging) {
            delete this.dragging;
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement?.el === this.el.parentElement) {
                delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement;
            }
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement.drop(e);
            }
        }
        delete this.helper;
        delete this.mouseDownEvent;
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement;
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement;
        delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].mouseHandled;
        e.preventDefault();
    }
    /** @internal call when keys are being pressed - use Esc to cancel, R to rotate */ _keyEvent(e) {
        const n = this.el.gridstackNode;
        const grid = n?.grid || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement?.el?.gridstack;
        if (e.key === 'Escape') {
            if (n && n._origRotate) {
            ...
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].canBeRotated(n)) return;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].swap(n._orig, 'w', 'h');
            delete n._rect;
    ...
    /** @internal create a clone copy (or user defined method) of the original drag item if set */ _createHelper() {
        ...
        if (typeof this.option.helper === 'function') {
            ...
            helper = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneNode(this.el);
        }
        if (!helper.parentElement) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].appendTo(helper, this.option.appendTo === 'parent' ? this.el.parentElement : this.option.appendTo);
        }
...
"[project]/node_modules/gridstack/dist/dd-droppable.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class DDDroppable extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$base$2d$impl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDBaseImplement"] {
    constructor(el, option = {}){
        super();
        this.el = el;
        this.option = option;
    ...
    enable() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.addEventListener('pointerenter', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerenter"]);
            this.el.addEventListener('pointerleave', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerleave"]);
        }
    }
    disable(forDestroy = false) {
        if (this.disabled === true) return;
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"]) {
            this.el.removeEventListener('pointerenter', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerenter"]);
            this.el.removeEventListener('pointerleave', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pointerleave"]);
        }
    }
    destroy() {
        this.disable(true);
    ...
    /** @internal called when the cursor enters our area - prepare for a possible drop and track leaving */ _mouseEnter(e) {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement) return;
        if (!this._canDrop(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement.el)) return;
        e.preventDefault();
        e.stopPropagation();
        // make sure when we enter this, that the last one gets a leave FIRST to correctly cleanup as we don't always do
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement !== this) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement._mouseLeave(e, true); // calledByEnter = true
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement = this;
        const ev = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].initEvent(e, {
            target: this.el,
            type: 'dropover'
        });
        if (this.option.over) {
            this.option.over(ev, this._ui(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement));
        }
        this.triggerEvent('dropover', ev);
        this.el.classList.add('ui-droppable-over');
    // console.log('tracking'); // TEST
    }
    /** @internal called when the item is leaving our area, stop tracking if we had moving item */ _mouseLeave(e, calledByEnter = false) {
        // console.log(`${count++} Leave ${this.el.id || (this.el as GridHTMLElement).gridstack.opts.id}`); // TEST
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement !== this) return;
        e.preventDefault();
        e.stopPropagation();
        const ev = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].initEvent(e, {
            target: this.el,
        ...
        if (this.option.out) {
            this.option.out(ev, this._ui(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement));
        }
        this.triggerEvent('dropout', ev);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement === this) {
            delete __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dropElement;
    ...
    /** item is being dropped on us - called by the drag mouseup handler - this calls the client drop event */ drop(e) {
        ...
        if (this.option.drop) {
            this.option.drop(ev, this._ui(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement));
        }
...
"[project]/node_modules/gridstack/dist/dd-element.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$resizable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-resizable.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$draggable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-draggable.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$droppable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-droppable.js [app-ssr] (ecmascript)");
;
;
;
class DDElement {
    ...
    setupDraggable(opts) {
        if (!this.ddDraggable) {
            this.ddDraggable = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$draggable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDDraggable"](this.el, opts);
        } else {
    ...
    setupResizable(opts) {
        if (!this.ddResizable) {
            this.ddResizable = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$resizable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDResizable"](this.el, opts);
        } else {
    ...
    setupDroppable(opts) {
        if (!this.ddDroppable) {
            this.ddDroppable = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$droppable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDDroppable"](this.el, opts);
        } else {
...
"[project]/node_modules/gridstack/dist/dd-gridstack.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-manager.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-element.js [app-ssr] (ecmascript)");
;
;
;
class DDGridStack {
    ...
    on(el, name, callback) {
        this._getDDElements(el).forEach((dEl)=>dEl.on(name, (event)=>{
                callback(event, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement.el : event.target, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].dragElement.helper : null);
            }));
        return this;
    }
    off(el, name) {
    ...
    /** @internal returns a list of DD elements, creating them on the fly by default unless option is to destroy or disable */ _getDDElements(els, opts) {
        ...
        const hosts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getElements(els);
        if (!hosts.length) return [];
        const list = hosts.map((e)=>e.ddElement || (create ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDElement"].init(e) : null)).filter((d)=>d); // remove nulls
        return list;
    }
} //# sourceMappingURL=dd-gridstack.js.map
}),
"[project]/node_modules/gridstack/dist/gridstack.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$gridstack$2d$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/gridstack-engine.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/utils.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/types.js [app-ssr] (ecmascript)");
/*
 * and include D&D by default
 * TODO: while we could generate a gridstack-static.js at smaller size - saves about 31k (41k -> 72k)
 * I don't know how to generate the DD only code at the remaining 31k to delay load as code depends on Gridstack.ts
 * also it caused loading issues in prod - see https://github.com/gridstack/gridstack.js/issues/2039
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$gridstack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-gridstack.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-touch.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-manager.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-element.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$draggable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gridstack/dist/dd-draggable.js [app-ssr] (ecmascript)");
...
;
;
const dd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$gridstack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDGridStack"];
;
;
;
;
 ...
 */ class GridStack {
     ...
     */ static init(options = {}, elOrString = '.grid-stack') {
        ...
        if (!el.gridstack) {
            el.gridstack = new GridStack(el, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep(options));
        }
        return el.gridstack;
    }
    /**
     ...
     */ static addGrid(parent, opt = {}) {
        ...
        if (!parentIsGrid || GridStack.addRemoveCB) {
            if (GridStack.addRemoveCB) {
                ...
                el = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
                    'grid-stack',
                    opt.class
                ], parent);
            }
     ...
     */ get placeholder() {
        if (!this._placeholder) {
            this._placeholder = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
                this.opts.placeholderClass,
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].itemClass,
                this.opts.itemClass
            ]);
            const placeholderChild = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
                'placeholder-content'
            ], this._placeholder);
     ...
     */ constructor(el, opts = {}){
        ...
        const rowAttr = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-row'));
        ...
        const defaults = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"]),
            column: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-column')) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].column,
            minRow: rowAttr ? rowAttr : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-min-row')) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].minRow,
            maxRow: rowAttr ? rowAttr : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-max-row')) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].maxRow,
            staticGrid: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-static')) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].staticGrid,
            sizeToContent: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-size-to-content')) || undefined,
            draggable: {
                handle: (opts.handleClass ? '.' + opts.handleClass : opts.handle ? opts.handle : '') || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].draggable.handle
            },
            removableOptions: {
                accept: opts.itemClass || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].removableOptions.accept,
                decline: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].removableOptions.decline
            }
        };
        if (el.getAttribute('gs-animate')) {
            defaults.animate = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-animate'));
        }
        opts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].defaults(opts, defaults);
        ...
        const parentGridItem = this.el.closest('.' + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].itemClass);
        ...
        if (this._isAutoCellHeight || opts.cellHeight === 'initial') {
            ...
            if (typeof opts.cellHeight == 'number' && opts.cellHeightUnit && opts.cellHeightUnit !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].cellHeightUnit) {
        ...
        if (opts.alwaysShowResizeHandle === 'mobile') {
            opts.alwaysShowResizeHandle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$touch$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTouch"];
        }
        this._setStaticClass();
        const engineClass = opts.engineClass || GridStack.engineClass || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$gridstack$2d$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GridStackEngine"];
        ...
        if (opts.subGridDynamic && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag = true;
        if (opts.draggable?.pause !== undefined) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag = opts.draggable.pause;
     ...
     */ addWidget(w) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].defaults(w, domAttr);
     ...
     */ createWidgetDivs(n) {
        const el = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
            'grid-stack-item',
            this.opts.itemClass
        ]);
        const cont = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
            'grid-stack-item-content'
        ], el);
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].lazyLoad(n)) {
     ...
     */ makeSubGrid(el, ops, nodeToAdd, saveContent = true) {
        ...
        ops = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep({
        ...
        if (saveContent) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].removeInternalForSave(newItemOpt);
            ...
            if (GridStack.addRemoveCB) {
                ...
                newItem = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
                    'grid-stack-item'
                ]);
                newItem.appendChild(content);
                content = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].createDiv([
                    'grid-stack-item-content'
                ], node.el);
            }
        ...
        if (nodeToAdd) {
            if (nodeToAdd._moving) {
                ...
                window.setTimeout(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].simulateMouseEvent(nodeToAdd._event, 'mouseenter', subGrid.el), 0);
            } else {
     ...
     */ removeAsSubGrid(nodeThatRemoved) {
        ...
        if (nodeThatRemoved) {
            window.setTimeout(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].simulateMouseEvent(nodeThatRemoved._event, 'mouseenter', pGrid.el), 0);
        }
    }
    /**
     ...
     */ save(saveContent = true, saveGridOpt = false, saveCB = GridStack.saveCB, column) {
        ...
        if (saveGridOpt) {
            const o = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep(this.opts);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].removeInternalAndSame(o, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"]);
            o.children = list;
            return o;
        }
        return list;
     ...
     */ load(items, addRemove = GridStack.addRemoveCB || true) {
        items = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep(items); // so we can mod
        ...
        items = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sort(items);
        ...
        if (!blank && addRemove) {
            ...
            copyNodes.forEach((n)=>{
                if (!n.id) return;
                const item = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].find(items, n.id);
                if (!item) {
        ...
        this.engine.nodes = this.engine.nodes.filter((n)=>{
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].find(items, n.id)) {
                updateNodes.push(n);
                return false;
        ...
        items.forEach((w)=>{
            const item = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].find(updateNodes, w.id);
            if (item) {
                // if item sizes to content, re-use the exiting height so it's a better guess at the final size (same if width doesn't change)
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(item)) w.h = item.h;
                ...
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].samePos(item, w) && this.engine.nodes.length > 1) {
                    this.moveNode(item, {
                        ...w,
                        forceCollide: true
                    });
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(w, item); // use possily updated values before update() is called next (no-op since already moved)
                }
     ...
     */ getCellHeight(forcePixel = false) {
        ...
        if (el) {
            const h = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-h')) || 1; // since we don't write 1 anymore
     ...
     */ cellHeight(val) {
        ...
        const data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].parseHeight(val);
    ...
    /** return our expected width (or parent) , and optionally of window for dynamic column check */ _widthOrContainer(forBreakpoint = false) {
     ...
     */ update(els, opt) {
        GridStack.getElements(els).forEach((el)=>{
            ...
            if (!n) return;
            const w = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos({}, n),
                ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].cloneDeep(opt)
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].sanitizeMinMax(n);
     ...
     */ margin(value) {
        ...
        if (!isMultiValue) {
            const data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].parseHeight(value);
    ...
    /** @internal */ _updateContainerHeight() {
        ...
        if (!parent && !this.opts.minRow) {
            const cssMinHeight = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].parseHeight(getComputedStyle(this.el)['minHeight']);
        ...
        if (parent && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(parent)) {
    ...
    /** @internal */ _prepareElement(el, triggerAddEvent = false, node) {
        ...
        el.classList.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gridDefaults"].itemClass, this.opts.itemClass);
        const sizeToContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(node);
        sizeToContent ? el.classList.add('size-to-content') : el.classList.remove('size-to-content');
        if (sizeToContent) this.resizeToContentCheck(false, node);
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].lazyLoad(node)) this.prepareDragDrop(node.el);
        return this;
    }
    ...
    /** @internal call to read any default attributes from element */ _readAttr(el, clearDefaultAttr = true) {
        const n = {};
        n.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-x'));
        n.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-y'));
        n.w = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-w'));
        n.h = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-h'));
        n.autoPosition = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-auto-position'));
        n.noResize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-no-resize'));
        n.noMove = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-no-move'));
        n.locked = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(el.getAttribute('gs-locked'));
        const attr = el.getAttribute('gs-size-to-content');
        if (attr) {
            if (attr === 'true' || attr === 'false') n.sizeToContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toBool(attr);
            else n.sizeToContent = parseInt(attr, 10);
        }
        n.id = el.getAttribute('gs-id');
        // read but never written out
        n.maxW = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-max-w'));
        n.minW = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-min-w'));
        n.maxH = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-max-h'));
        n.minH = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].toNumber(el.getAttribute('gs-min-h'));
    ...
    /** resizes content for given node (or all) if shouldSizeToContent() is true */ resizeToContentCheck(delay = false, n = undefined) {
        ...
        if (n) {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(n)) this.resizeToContentCBCheck(n.el);
        } else if (this.engine.nodes.some((n)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].shouldSizeToContent(n))) {
            const nodes = [
                ...this.engine.nodes
    ...
    /** add or remove the grid element size event handler */ _updateResizeEvent(forceRemove = false) {
        ...
        if (!forceRemove && trackSize && !this.resizeObserver) {
            this._sizeThrottle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].throttle(()=>this.onResize(), this.opts.cellHeightThrottle);
    ...
    /** @internal convert a potential selector into actual element */ static getElement(els = '.grid-stack-item') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getElement(els);
    }
    /** @internal */ static getElements(els = '.grid-stack-item') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getElements(els);
    }
    ...
    /** @internal initialize margin top/bottom/left/right and units */ _initMargin() {
        ...
        if (margins.length === 2) {
            ...
            data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].parseHeight(this.opts.margin);
        ...
        keys.forEach((k)=>{
            if (this.opts[k] === undefined) {
                ...
                data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].parseHeight(this.opts[k]);
                this.opts[k] = data.h;
     ...
     */ static setupDragIn(dragIn, dragInOptions, widgets, root = document) {
        if (dragInOptions?.pause !== undefined) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$dd$2d$manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DDManager"].pauseDrag = dragInOptions.pause;
        }
        dragInOptions = {
            appendTo: 'body',
            helper: 'clone',
        ...
        const els = typeof dragIn === 'string' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getElements(dragIn, root) : dragIn;
        els.forEach((el, i)=>{
            if (!dd.isDraggable(el)) dd.dragIn(el, dragInOptions);
            if (widgets?.[i]) el.gridstackNode = widgets[i];
        });
    }
    /**
    ...
    /** @internal called to add drag over to support widgets being added externally */ _setupAcceptWidget() {
            ...
            if (node._temporaryRemoved) {
                ...
                if (!this.engine.willItFit(node)) {
                    ...
                    if (node._willFitPos) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(node, node._willFitPos);
                        delete node._willFitPos;
                    }
                }
        ...
        dd.droppable(this.el, {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].copyPos(node, this._readAttr(this.placeholder)); // placeholder values as moving VERY fast can throw things off #1578
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].removePositioningStyles(el);
        ...
        if (!node._initDD) {
            ...
            /** called when the item stops moving/resizing */ const onEndMoving = (event)=>{
                ...
                if (node._isAboutToRemove) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].removePositioningStyles(target);
                    if (node._temporaryRemoved) {
    ...
    /** @internal handles actual drag/resize start */ _onStartMoving(el, event, ui, node, cellWidth, cellHeight) {
        ...
        if (node.grid?.el) {
            this.dragTransform = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getValuesFromTransformedElement(el);
        } else if (this.placeholder && this.placeholder.closest('.grid-stack')) {
            const gridEl = this.placeholder.closest('.grid-stack');
            this.dragTransform = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].getValuesFromTransformedElement(gridEl);
        } else {
            this.dragTransform = {
                xScale: 1,
                xOffset: 0,
    ...
    /** @internal handles actual drag/resize */ _dragOrResize(el, event, ui, node, cellWidth, cellHeight) {
        ...
        if (event.type === 'drag') {
            ...
            if (this.opts.draggable.scroll !== false) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].updateScrollPosition(el, ui.position, distance);
            }
        ...
        // if (node._lastTried && node._lastTried.x === x && node._lastTried.y === y) return;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"].updateScrollResize(event, el, cellHeight);
            // get new size
    ...
    commit() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["obsolete"])(this, this.batchUpdate(false), 'commit', 'batchUpdate', '5.2');
        return this;
    }
}
/**
...
/** scoping so users can call GridStack.Utils.sort() for example */ GridStack.Utils = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Utils"];
/** scoping so users can call new GridStack.Engine(12) for example */ GridStack.Engine = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gridstack$2f$dist$2f$gridstack$2d$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GridStackEngine"];
...
//# sourceMappingURL=node_modules_gridstack_dist_b93a2806._.js.map