...
class FileSystemService extends __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$services$2f$BaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    ...
    createFileSystemDirectory(projectId, createFileSystemDirectoryData) {
        if (!this.user.account) return Promise.reject();
        return this.post({
            ...
            url: "/".concat(projectId, "/fs"),
            data: createFileSystemDirectoryData
        });
    }
    createFileSystemFile(projectId, createFileSystemFileData) {
        if (!this.user.account) return Promise.reject();
...
function ProjectWidget(param) {
    ...
    const root = rootFileSystemDirectory != undefined ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DirectoryListItemButton, {
        fileSystemDirectoryData: rootFileSystemDirectory
    }, void 0, false, {
        fileName: "[project]/root/components/editor/widgets/ProjectWidget.tsx",
        lineNumber: 28,
        columnNumber: 7
    ...
    async function getFileSystem() {
        if (!project) return;
        const fileSystemDirectoryData = await fileSystemService.getFileSystemObject(project.id, project.fileSystemRootObjectId);
...
function DirectoryListItemButton(param) {
    let { fileSystemDirectoryData, children, ...listItemButtonProps } = param;
    _s1();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$ListItemButton$2f$ListItemButton$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ListItemButton$3e$__["ListItemButton"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CreateProjectDialog, {
...
_s1(DirectoryListItemButton, "AXQtczcZ1lYVozAevpNQ0294x1c=");
...
//# sourceMappingURL=_8474f104._.js.map