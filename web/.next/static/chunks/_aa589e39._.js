...
class ProjectStore {
    createProject(createProjectData) {
        return this._projectService.createProject(createProjectData);
    }
    deleteProject(projectId) {
    ...
    getProject(projectId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
            queryKey: this.getQueryKey(projectId),
    ...
    getProjects(getProjectsData) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
            queryKey: [
                typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$ProjectData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProjectSchema"],
                getProjectsData
            ],
            queryFn: ()=>this._projectService.getProjects(getProjectsData)
        });
    }
    async updateProject(projectId, updateProjectData) {
        const projectData = await this._projectService.updateProject(projectId, updateProjectData);
        // TODO: Figure out how to update the cached query data on the QueryClient
        return projectData;
    }
    ...
    async onFetch(ids) {
        const getProjectsData = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$ProjectData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GetProjectsSchema"].parseAsync({
            ids
        });
        const projectDatas = await this._projectService.getProjects(getProjectsData);
        const projectEntries = projectDatas.map((projectData)=>[
                projectData.id,
                projectData
            ]);
...
function ProjectContextProvider(param) {
    ...
    const { data } = projectStore.getProject(projectId);
    const value = {
        projectData: data
    };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$services$2f$BaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/services/BaseService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@strife/common/dist/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@strife/common/dist/FileSystemData.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inversify$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/inversify/lib/esm/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inversifyjs$2f$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@inversifyjs/core/lib/esm/index.js [app-client] (ecmascript)");
;
;
...
class FileSystemService extends __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$services$2f$BaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    ...
    createFileSystemDirectory(fileSystemId, createFileSystemDirectoryData) {
        if (!this.user.accountData) return Promise.reject();
        return this.post({
            schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileSystemDirectorySchema"],
            url: "/".concat(fileSystemId, "/objects"),
            data: createFileSystemDirectoryData
        });
    }
    createFileSystemFile(fileSystemId, createFileSystemFileData) {
        if (!this.user.accountData) return Promise.reject();
        return this.post({
            schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileSystemFileSchema"],
            url: "/".concat(fileSystemId, "/objects"),
    ...
    async getFileSystemObject(fileSystemId, fileSystemObjectId) {
        ...
        async function onFetch(ids) {
            const getAccountsData = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GetFileSystemObjectsSchema"].parseAsync({
                ids
            });
    ...
    async getFileSystemObjects(fileSystemId, getFileSystemObjectsData) {
        if (!this.user.accountData) return Promise.reject();
        return await this.get({
            schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnyFileSystemObjectSchema"].array(),
            url: "/".concat(fileSystemId, "/objects"),
            data: getFileSystemObjectsData
        });
    }
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "_batchersByProjectId", new Map());
    }
}
...
"[project]/root/components/file-system/FileSystemFileListItem.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>FileSystemFileListItem
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$DependencyInjection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/DependencyInjection.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$di$2f$managers$2f$ContextMenuManagerInjector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/di/managers/ContextMenuManagerInjector.ts [app-client] (ecmascript)");
...
;
;
function FileSystemFileListItem(param) {
    ...
    if (!fileSystemData || !fileSystemFileData) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, {}, void 0, false, {
        fileName: "[project]/root/components/file-system/FileSystemFileListItem.tsx",
        lineNumber: 26,
        columnNumber: 12
    }, this);
    ...
    async function getFileSystemFile() {
        ...
        const fileSystemFileData = await fileSystemService.getFileSystemObject(fileSystemData.id, fileSystemObjectId);
    ...
    async function onCreateCreateProjectDialog(createFileSystemFileData) {
        if (!fileSystemData) return;
...
_s(FileSystemFileListItem, "r3GBGYHIyKmi/AYLPr1p5IGd4TU=", false, function() {
    return [
...
_c = FileSystemFileListItem;
var _c;
__turbopack_context__.k.register(_c, "FileSystemFileListItem");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$di$2f$services$2f$FileSystemServiceInjector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/di/services/FileSystemServiceInjector.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemContext$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/components/file-system/FileSystemContext.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemDirectoryListItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/components/file-system/FileSystemDirectoryListItem.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemFileListItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/components/file-system/FileSystemFileListItem.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@strife/common/dist/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@strife/common/dist/FileSystemData.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
...
function FileSystemObjectListItem(param) {
    ...
    switch(anyFileSystemObjectData.type){
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileSystemObjectType"].Directory:
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemDirectoryListItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$strife$2f$common$2f$dist$2f$FileSystemData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileSystemObjectType"].File:
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemFileListItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                fileSystemObjectId: fileSystemObjectId,
                ...listItemProps
            }, void 0, false, {
                fileName: "[project]/root/components/file-system/FileSystemObjectListItem.tsx",
...
"[project]/root/components/file-system/FileSystemDirectoryListItem.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>FileSystemDirectoryListItem
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$DependencyInjection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/DependencyInjection.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$di$2f$managers$2f$ContextMenuManagerInjector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/root/src/di/managers/ContextMenuManagerInjector.ts [app-client] (ecmascript)");
...
;
;
function FileSystemDirectoryListItem(param) {
    let { fileSystemObjectId, ...listItemProps } = param;
    _s();
    const fileSystemService = __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$DependencyInjection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(__TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$di$2f$services$2f$FileSystemServiceInjector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileSystemServiceServiceId"]);
    const contextMenuManager = __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$DependencyInjection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(__TURBOPACK__imported__module__$5b$project$5d2f$root$2f$src$2f$di$2f$managers$2f$ContextMenuManagerInjector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ContextMenuManagerServiceId"]);
    ...
    async function getFileSystemDirectory() {
        if (!fileSystemData) return;
        const fileSystemDirectoryData = await fileSystemService.getFileSystemObject(fileSystemData.id, fileSystemObjectId);
    ...
    function onContextMenu(event) {
        ...
        contextMenuManager.request(contextMenuData);
    //setProjectWidgetContext({ ...fileSystemContext, contextMenuAnchorEl: event.currentTarget, contextMenuContent: <MenuItem onClick={onClickCreateDirectory}>Create Directory</MenuItem> });
    }
...
_s(FileSystemDirectoryListItem, "w33LZTkk0o/87aHNdkjrEXvNKpo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$styles$2f$useTheme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useTheme$3e$__["useTheme"],
        __TURBOPACK__imported__module__$5b$project$5d2f$root$2f$components$2f$file$2d$system$2f$FileSystemContext$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFileSystemContext"]
    ];
});
_c = FileSystemDirectoryListItem;
var _c;
__turbopack_context__.k.register(_c, "FileSystemDirectoryListItem");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_aa589e39._.js.map