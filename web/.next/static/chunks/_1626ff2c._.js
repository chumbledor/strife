...
function ProjectDirectoryListItem(param) {
    let { projectId, fileSystemObjectId, depth, ...listItemProps } = param;
    _s();
    ...
    async function getFileSystemDirectory() {
        const fileSystemDirectoryData = await fileSystemService.getFileSystemObject(fileSystemObjectId, projectId);
...
_s(ProjectDirectoryListItem, "lVjkOcLPeO3w4LYdTaYywhOjV58=", false, function() {
    return [
...
_s(ProjectWidgetContextProvider, "pxwivYuD+b9CWpZei4J4KOmKQg4=");
...
//# sourceMappingURL=_1626ff2c._.js.map