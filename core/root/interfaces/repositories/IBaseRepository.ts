...
interface IEntityRepository<TEntity extends object> {
  findOne<Hint extends string = never, Fields extends string = '*', Excludes extends string = never>(where: FilterQuery<TEntity>, options?: FindOneOptions<TEntity, Hint, Fields, Excludes>): Promise<Loaded<TEntity, Hint, Fields, Excludes> | null>;
      ...
      map(result: EntityDictionary<TEntity>, options?: { schema?: string; }): TEntity;
      getReference(id: Primary<TEntity>, options: Omit<GetReferenceOptions, 'wrapped'> & { wrapped: true; }): Ref<TEntity>;
      getReference(id: Primary<TEntity> | Primary<TEntity>[]): TEntity;
      getReference(id: Primary<TEntity>, options: Omit<GetReferenceOptions, 'wrapped'> & { wrapped: false; }): TEntity;
      ...
      create<Convert extends boolean = false>(data: EntityData<TEntity, Convert>, options: CreateOptions<Convert> & { partial: true; }): TEntity;
      // assign<Ent extends EntityType<TEntity>, Naked extends FromEntityType<Ent> = FromEntityType<Ent>, Convert extends boolean = false, Data extends EntityData<Naked, Convert> | Partial<EntityDTO<Naked>> = EntityData<Naked, Convert> | Partial<EntityDTO<Naked>>>(entity: Ent | Partial<Ent>, data: Data & IsSubset<EntityData<Naked, Convert>, Data>, options?: AssignOptions<Convert>): MergeSelected<Ent, Naked, keyof Data & string>;
